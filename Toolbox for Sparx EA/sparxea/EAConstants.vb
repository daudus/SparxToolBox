Public Class EAConstants
    ...
    Public Const stereotypeElementService = "ArchiMate_ApplicationService"
    Public Const stereotypeElementInterface = "ArchiMate_ApplicationInterface"
    ...
    Public Const stereotypeRelationUsedBy = "ArchiMate_UsedBy"
